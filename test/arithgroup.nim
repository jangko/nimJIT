...
proc testArithC(ctx: TestContext, inst, niminst: string) =
  ctx.testArith(inst, niminst, "byte", 400, 10)
  ctx.testArith(inst, niminst, "word", 400, 3000)
  ctx.testArith(inst, niminst, "dword", 400, 300000)
